...
// Attributes:
//  - Format
//  - IngressKey: session key encrypted for ingress node to read
//  - EgressKey: session key encrypted for egress node to read
// 
type KeySet struct {
	Format int32 `thrift:"format,1" db:"format" json:"format"`
...
// 
// Attributes:
//  - Bw: not set or none means no bandwidth constraint
//  - BwLimitBps
//  - DataCapID: empty/None means no data cap
//  - DataCapBytes
//  - DataCapAffinityAddr: tether address of service agent
// 
...
type Signature struct {
	...
	Signature []byte `thrift:"signature,2" db:"signature" json:"signature"`
}
...
//  - SourcePort
//  - DestPort
//  - Server: If this visa is for dock on server side.
//  - IcmpAllowed: list of allowed ICMP types
// 
type PEPArgsTCPUDP struct {
	SourceContactAddr []byte `thrift:"source_contact_addr,1" db:"source_contact_addr" json:"source_contact_addr"`
	DestContactAddr []byte `thrift:"dest_contact_addr,2" db:"dest_contact_addr" json:"dest_contact_addr"`
	SourcePort int32 `thrift:"source_port,3" db:"source_port" json:"source_port"`
	DestPort int32 `thrift:"dest_port,4" db:"dest_port" json:"dest_port"`
	Server bool `thrift:"server,5" db:"server" json:"server"`
...
//  - SourceContactAddr
//  - DestContactAddr
//  - IcmpTypeCode: the allowed ICMP type and code (in lower 16 bits)
//  - IcmpAntecedent: use 0xFF for none
//  - StateTimeoutMs: timeout for state in milliseconds
//  - OneShot: If we allow only one reply to a request
// 
type PEPArgsICMP struct {
	SourceContactAddr []byte `thrift:"source_contact_addr,1" db:"source_contact_addr" json:"source_contact_addr"`
	DestContactAddr []byte `thrift:"dest_contact_addr,2" db:"dest_contact_addr" json:"dest_contact_addr"`
	IcmpTypeCode int32 `thrift:"icmp_type_code,3" db:"icmp_type_code" json:"icmp_type_code"`
	IcmpAntecedent int32 `thrift:"icmp_antecedent,4" db:"icmp_antecedent" json:"icmp_antecedent"`
	StateTimeoutMs int32 `thrift:"state_timeout_ms,5" db:"state_timeout_ms" json:"state_timeout_ms"`
	OneShot bool `thrift:"one_shot,6" db:"one_shot" json:"one_shot"`
}
...
//  - IssuerID
//  - Configuration
//  - Expires: unix time (milliseconds)
//  - Source: packet source (tether address)
//  - Dest: packet sink (tether address)
//  - SourceContact: source contact addr
//  - DestContact: dest contact addr
//  - DockPep
//  - TcpudpPepArgs_
//  - IcmpPepArgs_
//  - SessionKey
...
type Visa struct {
	...
	Source []byte `thrift:"source,4" db:"source" json:"source"`
	Dest []byte `thrift:"dest,5" db:"dest" json:"dest"`
	SourceContact []byte `thrift:"source_contact,6" db:"source_contact" json:"source_contact"`
	DestContact []byte `thrift:"dest_contact,7" db:"dest_contact" json:"dest_contact"`
	DockPep PEPIndex `thrift:"dock_pep,8" db:"dock_pep" json:"dock_pep"`
	...
	SessionKey *KeySet `thrift:"session_key,11" db:"session_key" json:"session_key"`
...
//  - AgentType
//  - Attrs
//  - AuthExpires: unix time stamp
//  - ZprAddr: assigned ZPR address
//  - TetherAddr
//  - Ident: unique in this ZPRnet
//  - Provides
// 
type Agent struct {
...
// Attributes:
//  - ConnectionID
//  - DockAddr: dock ZPR address
//  - Claims
//  - Challenge: assume this is old protocol buffer challenge-request
//  - ChallengeResponses: assume this is old protocol buffer challenge-response
// 
...
// Attributes:
//  - ConnectionID: copied from request
//  - Status: SUCCESS if connect request granted
//  - Agent
//  - Reason: Optional message in case of non SUCCESS
// 
...
//  - Status
//  - Visa
//  - Reason: optional message if request has failed.
// 
...
type PolicyInfo struct {
	PolicyID int64 `thrift:"policy_id,1" db:"policy_id" json:"policy_id"`
	ConfigID int64 `thrift:"config_id,2" db:"config_id" json:"config_id"`
